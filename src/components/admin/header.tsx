...
import { Search, Bell, LogOut, User, LifeBuoy } from 'lucide-react';
      ...
      <div className="flex-1 max-w-xl">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-white/10 placeholder-gray-300 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent outline-none"
          />
        </div>
      </div>
