...
import { Search, Bell, LogOut, User, ChevronDown, LifeBuoy } from 'lucide-react';
      ...
      <div className="flex-1 max-w-xl">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-white/10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent outline-none"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 ml-6">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-3 px-3 py-2 hover:bg-blue-500 rounded-lg transition"
          >
